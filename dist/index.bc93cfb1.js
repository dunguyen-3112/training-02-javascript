...
module.bundle.HMR_BUNDLE_ID = "cd062d76bc93cfb1";
...
$(".control-search").next().addEventListener("keyup", (e)=>{
    ...
    else (0, _mainJs.FindUserByName)(e.target.value).then((data)=>show_table(data));
});
...
},{"../model/main.js":"ewzpH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ewzpH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "HandleFindAll", ()=>HandleFindAll);
parcelHelpers.export(exports, "HandleFindById", ()=>HandleFindById);
parcelHelpers.export(exports, "HandleFindByName", ()=>HandleFindByName);
...
const HandleUpdate = async (user)=>{
    return await HandleData(`http://localhost:3000/users/${user.id}`, {
        method: "PUT",
        headers: {
            "Content-Type": "application/json"
        },
